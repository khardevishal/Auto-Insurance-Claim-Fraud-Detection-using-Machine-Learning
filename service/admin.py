...
class ClaimQueryAdmin(admin.ModelAdmin):
    list_display = ('service_username', 'service_name', 'service_policy','service_accidentLoc', 'service_sex','service_maritalStatus', 'service_age', 'service_vehiclePrice', 'service_deductible',
                    'service_driverRating', 'service_addressChangeClaim', 'service_numberOfCars','service_ML_Output',
                    'service_Garage_Output', 'service_Garage_username', 'service_final_output','service_police_report',)
